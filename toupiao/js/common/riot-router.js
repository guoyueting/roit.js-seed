        ...
        riot.tag2('route', '', '', '', function(opts) {
            ...
            function mountContent(route, fresh) {
                ...
                if (route && route.tag && route.tag.toUpperCase() !== firstChildTagName || fresh) {
                    ...
                    if (Object.prototype.toString.call(self.tagObj.routeChangeExec) === "[object Function]") {
            ...
            self.mountContent = self.root.mountContent = mountContent;
            ...
            self.testRoute = self.root.testRoute = testRoute;
